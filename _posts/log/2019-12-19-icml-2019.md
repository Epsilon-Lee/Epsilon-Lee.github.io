...
- [1]
  ...
  **Tech. contribution**
  ...
  ![understand_bias_embed_algorithm](fig/understand_bias_embed_algorithm.png)
...
- [1]
  ...
  **TL; DR**
  ...
  ![mass_training_paradigm](fig/mass_training_paradigm.png)
  ...
  **Other baselines**
  ...
  ![mass_baselines](fig/mass_baselines.png)
  ...
  ![mass_choice_of_k](fig/mass_choice_of_k.png)
...
![residual_nlg_general_arch](fig/residual_nlg_general_arch.png)
  ![residual_nlg_arch](fig/residual_nlg_arch.png)
...
- [4]
  ...
  **Very poor ablation**
  ...
  ![unsupervised_asr](fig/unsupervised_asr_ablation.png)
...
- [6]
  ...
  **Training algorithm**
  ...
  ![progressive_stack_illustration](fig/progressive_stack_illustration.png)

  ![progressive_stack_algo](fig/progressive_stack_algo.png)
